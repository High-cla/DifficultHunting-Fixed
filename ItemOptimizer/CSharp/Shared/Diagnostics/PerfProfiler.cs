...
namespace ItemOptimizerMod
{
    ...
    static class PerfProfiler
    {
        ...
        /// <summary>Per-thread item start timestamp for profiler timing. Serial access assumed — the profiler's record/flush cycle runs on a single thread, never accessed concurrently.</summary>
        [ThreadStatic]
        ...
        // Component type → lane mapping for ClassifyLane
        private static readonly Dictionary<string, string> _componentLaneMap = new(StringComparer.Ordinal)
        {
            { "MotionSensor", "sensor" },
            { "WaterDetector", "sensor" },
            { "OxygenDetector", "sensor" },
            { "RelayComponent", "logic" },
            { "SignalCheckComponent", "logic" },
            { "AdderComponent", "logic" },
            { "MultiplyComponent", "logic" },
            { "DivideComponent", "logic" },
            { "SubtractComponent", "logic" },
            { "NotComponent", "logic" },
            { "AndComponent", "logic" },
            { "OrComponent", "logic" },
            { "XorComponent", "logic" },
            { "EqualsComponent", "logic" },
            { "GreaterComponent", "logic" },
            { "MemoryComponent", "logic" },
            { "OscillatorComponent", "logic" },
            { "DelayComponent", "logic" },
            { "ConcatComponent", "logic" },
            { "RegExFindComponent", "logic" },
            { "StringComponent", "logic" },
            { "ColorComponent", "logic" },
            { "TrigonometricFunctionComponent", "logic" },
            { "ModuloComponent", "logic" },
            { "AbsComponent", "logic" },
            { "SquareRootComponent", "logic" },
            { "RoundComponent", "logic" },
            { "CeilingComponent", "logic" },
            { "FloorComponent", "logic" },
            { "WiFiComponent", "logic" },
            { "Terminal", "logic" },
            { "CustomInterface", "logic" },
            { "PowerTransfer", "power" },
            { "PowerContainer", "power" },
            { "Reactor", "power" },
            { "PoweredController", "power" },
            { "Door", "door" },
            { "Pump", "pump" },
        };
        ...
        private static string ClassifyLane(Item item)
        {
            ...
            foreach (var comp in item.Components)
            {
                ...
                if (_componentLaneMap.TryGetValue(typeName, out var mappedLane))
                {
                    lane = mappedLane;
                    break;
                }

                if (typeName == "Wearable" && lane == "other")
                    lane = "wearable";
                else if (typeName == "Wire" && lane == "other")
                    lane = "wire";
            }
            IdToLane[id] = lane;
            return lane;
