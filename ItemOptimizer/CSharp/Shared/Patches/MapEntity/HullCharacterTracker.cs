...
namespace ItemOptimizerMod
{
    ...
    static class HullCharacterTracker
    {
        ...
        // Hull.ID → characters in that hull. Flat array indexed by entity ID (max MaxItemId).
        private static readonly List<Character>[] _hullCharacters = new List<Character>[MaxItemId];
        ...
        // Track which slots were used this frame to avoid clearing all MaxItemId
