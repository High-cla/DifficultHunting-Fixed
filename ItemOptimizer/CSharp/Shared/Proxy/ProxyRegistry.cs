...
namespace ItemOptimizerMod.Proxy
{
    ...
    public static class ProxyRegistry
    {
        ...
        {
            return _handlerMap.ContainsKey(prefabId);
        }
        ...
        /// <summary>Detach all attached items via their handlers. Shared loop used by DetachAllItems and DetachAll.</summary>
        private static void DetachAllAttachedItems()
        {
            foreach (var item in Item.ItemList)
            {
