...
namespace ItemOptimizerMod.World
{
    ...
    internal static partial class NativeRuntimeBridge
    {
        ...
        /// </summary>
        internal static readonly bool[] IsZoneManaged = new bool[MaxItemId];
        ...
        /// </summary>
        internal static readonly byte[] SubZoneTier = new byte[MaxItemId];
        ...
        internal static void OnRoundEnd()
        {
            ...
            System.Array.Clear(IsZoneManaged, 0, MaxItemId);
            System.Array.Clear(SubZoneTier, 0, MaxItemId);
        }
