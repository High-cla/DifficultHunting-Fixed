...
namespace ItemOptimizerMod.World.Sensors
{
    ...
    internal sealed class MotionSensorNative : NativeComponent
    {
        ...
        /// <summary>Matches the vanilla Prefix signal step value.</summary>
        private const int DefaultStepValue = 1;
        ...
        public override void Tick(ref TickContext ctx)
        {
            ...
            if (!string.IsNullOrEmpty(signalOut))
            {
                ...
                if (conn != null)
                    ctx.EmitSignal(conn, signalOut, stepValue: DefaultStepValue);
            }
