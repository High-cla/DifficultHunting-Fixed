...
namespace ItemOptimizerMod.World
{
    ...
    public sealed class CommandBuffer
    {
        ...
        /// <summary>Per-thread merge dictionary for hull water commands. Serial access assumed within each NativeRuntime tick phase (Phase 4 → Phase 5 flush on main thread).</summary>
        [ThreadStatic]
        private static Dictionary<ulong, HullWaterCmd> _mergeHullWater;
        /// <summary>Per-thread merge dictionary for physics force commands. Serial access assumed within each NativeRuntime tick phase (Phase 4 → Phase 5 flush on main thread).</summary>
        [ThreadStatic]
