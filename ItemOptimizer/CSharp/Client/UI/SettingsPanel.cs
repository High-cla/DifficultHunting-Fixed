...
namespace ItemOptimizerMod
{
    static partial class SettingsPanel
    {
        ...
        {
            public GUIFrame Container { get; set; }
            public GUITextBox IdentifierBox { get; set; }
            public GUIDropDown ActionDropDown { get; set; }
            public GUITextBox SkipBox { get; set; }
            public GUIDropDown ConditionDropDown { get; set; }
            public GUIListBox SuggestionList { get; set; }
        ...
        private class ModPanelRefs
        {
            ...
            public GUIScrollBar IntensitySlider { get; set; }
            public GUITextBlock IntensityPercent { get; set; }
            public GUITextBlock IntensityPreview { get; set; }
            public List<(GUIScrollBar Slider, GUITextBox NumBox, ModTierInfo TierInfo)> TierControls { get; set; } = new();
        }
