...
namespace ItemOptimizerMod
{
    static partial class SettingsPanel
    {
        ...
        {
            public ActivityTier Tier { get; set; }
            public List<ModItemInfo> Items { get; set; } = new();
            public int RecommendedSkip { get; set; }
        ...
        private class ModInfo
        {
            ...
            public Dictionary<ActivityTier, ModTierInfo> Tiers { get; set; } = new();
        }
